  ...
  <div className="space-y-8">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <MetricCard
        title="Volatility"
        value={
          data?.risk_management?.volatility !== undefined
            ? `${(data.risk_management.volatility * 100).toFixed(1)}%`
            : "-"
        }
      ...
      <MetricCard
        title="Max Drawdown"
        value={
          data?.risk_management?.max_drawdown !== undefined
            ? `${(data.risk_management.max_drawdown * 100).toFixed(1)}%`
            : "-"
        }
